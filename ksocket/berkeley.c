...
int socket_connection(int doMASTER, int type, int protocol)
{
	NTSTATUS Status;
	PKSOCKET Socket;
...
int socket_listen(int doMASTER, int type, int protocol)
{
	NTSTATUS Status;
	PKSOCKET Socket;
...
int socket_datagram(int doMASTER, int type, int protocol)
{
	NTSTATUS Status;
	PKSOCKET Socket;
